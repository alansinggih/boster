...
var seleFaat = $("<select class='faat' id='faat"+ouou+"'/>")
...
var btn = $("<button class='Btn' id='Btn"+ouou+"' onclick='hapus()'><i class='icon-remove-sign'/></button>");  
    ...
    /*Append*/
$(".sfilter").append(div)
$('#luar'+ouou).append(lab2,xutox,autox1,/*JamMulai,MenitMulai,JamSelesai,MenitSelesai,*/seleROL,seleFaat,txtArea,Jumlah,sat,btn);
...
var fft = $("select[id='manfaat'] option").attr('value');
var fat0 = $('#manfaat option[value="0"]').text();
var fat1 = $('#manfaat option[value="1"]').text();
var fat2 = $('#manfaat option[value="2"]').text();
var fat3 = $('#manfaat option[value="3"]').text();
$('#faat'+ouou).append($("<option></option>").attr("value","0").text(fat0));
$('#faat'+ouou).append($("<option></option>").attr("value","1").text(fat1));
$('#faat'+ouou).append($("<option></option>").attr("value","2").text(fat2));
$('#faat'+ouou).append($("<option></option>").attr("value","3").text(fat3));

  
  
$('button#Btn'+ouou).click(function(){
   var ag = $('button.Btn').index(this)+1;
    $('#lb2'+ag+',#xuto'+ag+',#auto1'+ag+',#JamMulai'+ag+',#MenitMulai'+ag+',#JamSelesai'+ag+',#JamSelesai'+ag+',#rol'+ag+',#faat'+ag+',#txt'+ag+',#Jml'+ag+',#Sat'+ag+',#luar'+ag+',#Btn'+ag).remove();
});
...
function buat(Jm,Mm,Js,Ms,Pil,Rinc,Jml,Sat,manf){    
...
if (confirm('Input Kegiatan ke '+ abc + '\n\n' + $('#rol'+abc).children("option:selected").text() +'\n.' )) {
    ...
    $('#rol'+abc).val(),$('#txt'+abc).val(),$('#Jml'+abc).val(),$('#Sat'+abc).val(),$('#faat'+abc).val());
    tutup()
    none()
} else {
